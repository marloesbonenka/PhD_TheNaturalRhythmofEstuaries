...
# map_output_interval = 30    # minutes (Flmap interval)
# his_output_interval = 30     # minutes (Flhis interval) 
...
run_spatial_plots = False                # Set to True to run, set to False to skip this section
run_width_averaged_bedlevel = False      # Set to True to run, set to False to skip this section
run_braiding_analysis = False            # Set to True to run, set to False to skip this section
run_hypsometric_analysis = False         # Set to True to run, set to False to skip this section
run_multi_scenario_hypsometric = True    # Set to True to run, set to False to skip this section
